    ...
    <div>
      <div className="text-center">
        ...
        <p className="mt-1.5 text-sm text-slate-500">
          One last step! Make sure everything is correct before submitting your
          business to our moderation team.
        </p>
      </div>
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm">
            ...
            <div className="mt-4">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Located in the heart of the city, we offer authentic Provençal
                cuisine with fresh and local products from the market. A unique
                culinary experience in a green setting.
              </p>
            </div>
          </div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="space-y-3">
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium text-slate-800">
                    15 Rue des Lilas, 75001 Paris, France
                  </p>
                </div>
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-wide text-slate-400">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium text-[#00663f]">
                    www.lejardindeprovence.fr
                  </p>
                </div>
              </div>
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2.5 sm:grid-cols-4">
              ...
              <div className="rounded-lg bg-slate-50 px-3 py-2.5 text-center">
                ...
                <p className="mt-0.5 text-xs font-medium text-[#c0524d]">
                  Closed
                </p>
              </div>
        ...
        <div className="space-y-5">
          <div className="rounded-2xl bg-[#00663f] p-5 text-white shadow-sm">
            ...
            <p className="mt-1.5 text-xs text-white/75">
              ...
              is accurate and that you accept our terms of use.
            </p>
            ...
            <p className="mt-3 text-center text-[11px] text-white/60">
              Average validation time: 24h to 48h
            </p>
          </div>

          <div className="rounded-2xl bg-slate-50 p-5">
            <p className="text-xs text-slate-500">
              Our teams here to support you in your digital visibility.
            </p>
            <Link
              href="/contact"
